...
var TRANSLATIONS = {
  es: {
    ...
    'gifts.text': 'Su presencia es el mejor regalo. Si desean tener un detalle con nosotros para nuestra luna de miel, contaremos con un buzón de sobres el día de la boda o si lo prefieren, pueden realizar una transferencia a nuestra cuenta.',
    'gifts.clabe': 'CLABE',
    'gifts.bank': 'Banco',
  ...
  en: {
    ...
    'gifts.text': 'Your presence is the greatest gift. If you would like to give us something for our honeymoon, we will have an envelope box at the wedding, or if you prefer, you can make a transfer to our account.',
    'gifts.clabe': 'CLABE',
    'gifts.bank': 'Bank',
